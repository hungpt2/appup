<template>
  <div class="hello">
    <h1>{{ msg }}</h1>
    <br/>
    <!-- <appup-listGrid view='appup-listView' :data=listGridData :columns=columns :caption=caption /> -->
  </div>
</template>
...
export default {
  data () {
    return {
      msg: 'List-Grid',
      caption: 'Click on the icon to switch the view -->',
      columns: ['title', 'url', 'image'],
      listGridData: [{
